          ...
          <div className="relative lg:static xl:pl-10">
            ...
            <div className="relative">
              ...
              <Image
                ...
                priority
              />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-teal-300 via-teal-300/70 to-green-300 opacity-10 blur-lg" />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-teal-300 via-teal-300/70 to-green-300 opacity-10" />
