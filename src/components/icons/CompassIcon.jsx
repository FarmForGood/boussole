...
export function CompassIcon({ quarter, inline }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={inline === 'true' ? '24' : '36'}
      height={inline === 'true' ? '24' : '36'}
      className={inline === 'true' ? 'inline-block' : ''}
      viewBox="0 0 510 510"
    >
      <path
        fillRule="evenodd"
