...
const styles = {
  note: {
    ...
    body: 'text-teal-800 [--tw-prose-background:theme(colors.sky.50)] prose-a:text-teal-900 prose-code:text-teal-900 dark:text-slate-300 dark:prose-code:text-slate-300',
  },
  warning: {
    container:
